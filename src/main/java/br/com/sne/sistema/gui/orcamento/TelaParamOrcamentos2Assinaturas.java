...
public class TelaParamOrcamentos2Assinaturas extends JFrame implements ActionListener{
	...
	public TelaParamOrcamentos2Assinaturas(){
		
		//configurando a janela
		setTitle("Relatório de Orçamentos Fechados com Duas Assinaturas por Período");
		...
		labelTitulo.setBounds(new Rectangle(65, 20, 400, 29));
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == botaoGerar) {
			...
			if((codVendedor != 0 && radioPorVendedor.isSelected()) || radioTodos.isSelected()){
				...
				hm.put("dataHoje", new Date());
				hm.put("datainicial", fieldDataInicial.getDate());
				hm.put("datafinal", fieldDataFinal.getDate());
				
				URL arquivo = null;
				if(radioTodos.isSelected()){
					arquivo = getClass().getResource("/br/com/sne/sistema/report/orcamentosDuasAssinaturas.jasper"); 
				}
				else{
					hm.put("id", codVendedor);
					arquivo = getClass().getResource("/br/com/sne/sistema/report/orcamentosDuasAssinaturasIndividual.jasper"); 
				}
				try {
					setVisible(false);
		...
		if(e.getSource() == botaoLocalizarVendedor){
			...
			DialogSearchFuncionario teste = new DialogSearchFuncionario(TelaParamOrcamentos2Assinaturas.this, listaFuncionario);
			Funcionario f = teste.showDialog(TelaParamOrcamentos2Assinaturas.this);
			if(f != null) {
