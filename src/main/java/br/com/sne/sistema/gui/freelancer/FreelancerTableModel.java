...
public class FreelancerTableModel extends SizedTableModel<Freelancer> {
	...
	private Class<?> columnClass[] = {Long.class,  Freelancer.class, String.class};
	
	public void addElement(Freelancer grp) {
