...
public class TelaParamEquipamentosDescartadosPeriodoMotivo extends JFrame implements ActionListener{
	...
	public TelaParamEquipamentosDescartadosPeriodoMotivo(){
		
		//configurando a janela
		setTitle("Relatório de Equipamentos Descartados por Período e por Motivo");
		...
		Icon imagem = new ImageIcon(getClass().getResource("/images/lixo_48.png"));
		...
		if(e.getSource() == botaoGerar) {
			//recebe a entrada do usuário
				...
				try {
					...
					URL arquivo = getClass().getResource("/br/com/sne/sistema/report/equipamentosDescartadosPeriodoMotivo.jasper");  
