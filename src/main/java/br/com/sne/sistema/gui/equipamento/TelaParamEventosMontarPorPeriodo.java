...
public class TelaParamEventosMontarPorPeriodo extends JFrame implements ActionListener{
	...
	public TelaParamEventosMontarPorPeriodo(){
		...
		if(e.getSource() == botaoGerar) {
			//recebe a entrada do usuário
				...
				try {
					...
					URL arquivo = getClass().getResource("/br/com/sne/sistema/report/eventosMontarPorPeriodo.jasper");  
