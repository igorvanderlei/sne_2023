...
public class TelaParamDespesasPagasPeriodoFornecedor extends JFrame implements ActionListener{
	...
	public TelaParamDespesasPagasPeriodoFornecedor(){
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == botaoGerar) {
			if(codFornecedor != 0 && radioPorFornecedor.isSelected() || radioTodos.isSelected()){
					...
					if(radioTodos.isSelected()){
						arquivo = getClass().getResource("/br/com/sne/sistema/report/despesasPagasPeriodoFornecedor.jasper");  
					}else{
						hm.put("id", codFornecedor);
						arquivo = getClass().getResource("/br/com/sne/sistema/report/despesasPagasPeriodoFornecedorIndividual.jasper");  
					}
					try {
						setVisible(false);
		...
		if(e.getSource() == botaoLocalizarFornecedor){
			DialogSearchFornecedor teste = new DialogSearchFornecedor(TelaParamDespesasPagasPeriodoFornecedor.this);
			Fornecedor c = teste.showDialog(TelaParamDespesasPagasPeriodoFornecedor.this);
			if(c != null) {
