...
public class TelaParamOrcamentosPerdidos extends JFrame implements ActionListener{
	...
	public TelaParamOrcamentosPerdidos(){
		
		//configurando a janela
		setTitle("Relatório de Orçamentos Perdidos por Período");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == botaoGerar) {
			...
			if((codVendedor != 0 && radioPorVendedor.isSelected()) || radioTodos.isSelected()){
				...
				if(radioTodos.isSelected()){
					arquivo = getClass().getResource("/br/com/sne/sistema/report/orcamentosPerdidos.jasper"); 
				}
				else{
					hm.put("id", codVendedor);
					arquivo = getClass().getResource("/br/com/sne/sistema/report/orcamentosPerdidosIndividual.jasper"); 
				}
				try {
					setVisible(false);
		...
		if(e.getSource() == botaoLocalizarVendedor){
			...
			DialogSearchFuncionario teste = new DialogSearchFuncionario(TelaParamOrcamentosPerdidos.this, listaFuncionario);
			Funcionario f = teste.showDialog(TelaParamOrcamentosPerdidos.this);
			if(f != null) {
