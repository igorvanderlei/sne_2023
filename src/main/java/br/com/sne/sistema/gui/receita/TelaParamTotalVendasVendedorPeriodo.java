...
public class TelaParamTotalVendasVendedorPeriodo extends JFrame implements ActionListener{
	...
	public TelaParamTotalVendasVendedorPeriodo(){
		
		//configurando a janela
		setTitle("Total de Vendas por Vendedor e por Período:");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == botaoGerar) {
			...
			if(codVendedor != 0 && radioPorVendedor.isSelected() || radioTodos.isSelected()){
					...
					if(radioTodos.isSelected()){
						arquivo = getClass().getResource("/br/com/sne/sistema/report/totalVendasPorVendedorPorPeriodo.jasper");  
					}else{
						hm.put("id", codVendedor);
						arquivo = getClass().getResource("/br/com/sne/sistema/report/totalVendasPorVendedorPorPeriodo2.jasper");  
					}
					try {
						setVisible(false);
		...
		if(e.getSource() == botaoLocalizarVendedor){
			...
			DialogSearchFuncionario teste = new DialogSearchFuncionario(TelaParamTotalVendasVendedorPeriodo.this, listaFuncionario);
			Funcionario f = teste.showDialog(TelaParamTotalVendasVendedorPeriodo.this);
			if(f != null) {
