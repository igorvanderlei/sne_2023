...
public class TelaParamParcelasPagasPorClientePeriodo extends JFrame implements ActionListener{
	...
	public TelaParamParcelasPagasPorClientePeriodo(){
		
		//configurando a janela
		setTitle("Parcelas Pagas por Período e por Cliente:");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == botaoGerar) {
			if(codCliente != 0 && radioPorCliente.isSelected() || radioTodos.isSelected()){
					...
					if(radioTodos.isSelected()){
						arquivo = getClass().getResource("/br/com/sne/sistema/report/parcelasPagasPorClientePeriodo.jasper");  
					}else{
						hm.put("id", codCliente);
						arquivo = getClass().getResource("/br/com/sne/sistema/report/parcelasPagasPorClientePeriodoIndividual.jasper");  
					}
					try {
						setVisible(false);
		...
		if(e.getSource() == botaoLocalizarCliente){
			DialogSearchClient teste = new DialogSearchClient(TelaParamParcelasPagasPorClientePeriodo.this);
			Cliente c = teste.showDialog(TelaParamParcelasPagasPorClientePeriodo.this);
			if(c != null) {
