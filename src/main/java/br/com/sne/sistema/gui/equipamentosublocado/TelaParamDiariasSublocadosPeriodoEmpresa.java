...
public class TelaParamDiariasSublocadosPeriodoEmpresa extends JFrame implements ActionListener{
	...
	public TelaParamDiariasSublocadosPeriodoEmpresa(){
		
		//configurando a janela
		setTitle("Relatório de Diárias dos Sublocados por Período e por Empresa");
		...
		//setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //Encerra a operaçao quando fecha a janela
		...
		Icon imagem = new ImageIcon(getClass().getResource("/images/equipamento_s.png"));
		...
		if(e.getSource() == botaoGerar) {
			//recebe a entrada do usuário
				...
				try {
					...
					URL arquivo = getClass().getResource("/br/com/sne/sistema/report/DiariasSublocadosPeriodoEmpresa.jasper");  
