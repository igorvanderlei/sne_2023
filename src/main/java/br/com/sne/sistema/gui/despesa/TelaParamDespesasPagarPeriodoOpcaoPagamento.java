...
public class TelaParamDespesasPagarPeriodoOpcaoPagamento extends JFrame implements ActionListener{
	...
	public TelaParamDespesasPagarPeriodoOpcaoPagamento(){
		...
		if(e.getSource() == botaoGerar) {
			if(radioPorOpcaoPagamento.isSelected() || radioTodos.isSelected()){
					...
					if(radioTodos.isSelected()){
						arquivo = getClass().getResource("/br/com/sne/sistema/report/despesasPagarPeriodoOpcaoPagamento.jasper");  
					}else{
						
						hm.put("id", ((OpcaoPagamento)fieldOpcaoPagamento.getSelectedItem()).ordinal());
						arquivo = getClass().getResource("/br/com/sne/sistema/report/despesasPagarPeriodoOpcaoPagamentoIndividual.jasper");  
					}
					try {
						setVisible(false);
