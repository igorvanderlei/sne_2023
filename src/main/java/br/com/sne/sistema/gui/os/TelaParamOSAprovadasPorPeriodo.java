...
public class TelaParamOSAprovadasPorPeriodo extends JFrame implements ActionListener{
	...
	public TelaParamOSAprovadasPorPeriodo(){
		
		//configurando a janela
		setTitle("Relatório de Ordens de Serviço Aprovadas por Período");
		...
		Icon imagem = new ImageIcon(getClass().getResource("/images/os_aprovada_48.png"));
		...
		if(e.getSource() == botaoGerar) {
			//recebe a entrada do usuário
				...
				try {
					...
					URL arquivo = getClass().getResource("/br/com/sne/sistema/report/ordemServicoAprovadasPorPeriodo.jasper");  
