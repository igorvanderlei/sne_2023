...
public class TelaParamEquipeTecnicaPorEvento extends JFrame implements ActionListener{
	...
	public TelaParamEquipeTecnicaPorEvento(){
		...
		if(e.getSource() == botaoGerar) {
			//recebe a entrada do usuário
				...
				try {
					...
					URL arquivo = getClass().getResource("/br/com/sne/sistema/report/equipeTecnicaPorEvento.jasper");  
