...
public class TelaParamFreelancersPorPeriodo extends JFrame implements ActionListener{
	...
	public TelaParamFreelancersPorPeriodo(){
		
		//configurando a janela
		setTitle("Relatório de Freelancers por Período");
		...
		Icon imagem = new ImageIcon(getClass().getResource("/images/freelancer_48.png"));
		...
		if(e.getSource() == botaoGerar) {
			//recebe a entrada do usuário
				...
				try {
					...
					URL arquivo = getClass().getResource("/br/com/nordesti/locav/report/freelancersPorPeriodo.jasper");  
