...
public class DefaultSearchDialog<T, TModel extends SizedTableModel<T>> extends JDialog {
    ...
    public DefaultSearchDialog(Component comp, java.util.List<T> possibleValues, String title, TModel tableModel) {
    	super();
    	setTitle(title);
        setSize(720, 400);   
        
        setIconImage((new ImageIcon("images/find.png")).getImage());
        
    	setModalityType(DEFAULT_MODALITY_TYPE);
    	setLocationRelativeTo(null);
    	this.tableModel = tableModel;
    	this.data = possibleValues;
	...
	private JComboBox<String> getJComboBoxFiltro() {
