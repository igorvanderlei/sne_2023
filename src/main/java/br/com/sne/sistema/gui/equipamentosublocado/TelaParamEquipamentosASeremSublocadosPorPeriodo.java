...
public class TelaParamEquipamentosASeremSublocadosPorPeriodo extends JFrame implements ActionListener{
	...
	public TelaParamEquipamentosASeremSublocadosPorPeriodo(){
		
		//configurando a janela
		setTitle("Relatório de Equipamentos a Serem Sublocados por Período");
		...
		if(e.getSource() == botaoGerar) {
			//recebe a entrada do usuário
				...
				try {
					...
					URL arquivo = getClass().getResource("/br/com/sne/sistema/report/equipamentosASeremSublocadosPorPeriodo.jasper");  
