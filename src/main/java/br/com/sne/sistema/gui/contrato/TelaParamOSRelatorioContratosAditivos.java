...
public class TelaParamOSRelatorioContratosAditivos extends JFrame implements ActionListener{
	...
	public TelaParamOSRelatorioContratosAditivos(){
		
		//configurando a janela
		setTitle("Relatório de Contratos Aditivos por Período");
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == botaoGerar) {
			...
			if((codVendedor != 0 && radioPorVendedor.isSelected()) || radioTodos.isSelected()){
				...
				if(radioTodos.isSelected()){
					arquivo = getClass().getResource("/br/com/nordesti/locav/report/contratosAditivosPorPeriodo.jasper"); 
				}
				else{
					hm.put("id", codVendedor);
					arquivo = getClass().getResource("/br/com/nordesti/locav/report/contratosAditivosPorPeriodoIndividual.jasper"); 
				}
				try {
					setVisible(false);
		...
		if(e.getSource() == botaoLocalizarVendedor){
			...
			DialogSearchFuncionario teste = new DialogSearchFuncionario(TelaParamOSRelatorioContratosAditivos.this, listaFuncionario);
			Funcionario f = teste.showDialog(TelaParamOSRelatorioContratosAditivos.this);
			if(f != null) {
