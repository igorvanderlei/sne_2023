...
public class TelaParamPautasPorPeriodo extends JFrame implements ActionListener{
	...
	public TelaParamPautasPorPeriodo(){
		
		//configurando a janela
		setTitle("Relatório de Pautas por Período");
		...
		Icon imagem = new ImageIcon(getClass().getResource("/images/pauta_48.png"));
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == botaoGerar) {
			...
			if((codVendedor != 0 && radioPorVendedor.isSelected()) || radioTodos.isSelected()){
				...
				if(radioTodos.isSelected()){
					arquivo = getClass().getResource("/br/com/sne/sistema/report/pautasPorPeriodo.jasper"); 
				}
				else{
					hm.put("id", codVendedor);
					arquivo = getClass().getResource("/br/com/sne/sistema/report/pautasPorPeriodoIndividual.jasper"); 
				}
				try {
					setVisible(false);
		...
		if(e.getSource() == botaoLocalizarVendedor){
			...
			DialogSearchFuncionario teste = new DialogSearchFuncionario(TelaParamPautasPorPeriodo.this, listaFuncionario);
			Funcionario f = teste.showDialog(TelaParamPautasPorPeriodo.this);
			if(f != null) {
