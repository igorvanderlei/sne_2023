...
public class TelaParamEquipamentosDescartados extends JFrame implements ActionListener{
	...
	public TelaParamEquipamentosDescartados(){
		...
		if(e.getSource() == botaoGerar) {
			//recebe a entrada do usuário
				...
				try {
					...
					URL arquivo = getClass().getResource("/br/com/sne/sistema/report/controleEquipamentosDescartados.jasper");  
