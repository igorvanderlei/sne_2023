...
public class TelaParamQtdDiariasSublocadosPorPeriodo extends JFrame implements ActionListener{
	...
	public TelaParamQtdDiariasSublocadosPorPeriodo(){
		
		//configurando a janela
		setTitle("Relatório de Diárias dos Sublocados por Período");
		...
		if(e.getSource() == botaoGerar) {
			//recebe a entrada do usuário
				...
				try {
					...
					URL arquivo = getClass().getResource("/br/com/sne/sistema/report/quantitativoDiariasSublocadosPorPeriodo.jasper");  
